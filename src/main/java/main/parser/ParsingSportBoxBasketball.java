...
public class ParsingSportBoxBasketball extends Data  {
    Map<String, String> categories_nameDic;
    public ParsingSportBoxBasketball() {
        source_id = 2L;
        category_id = 1L;
        categories_name = new String[] {
                "nba", "vtb" };
        categories_nameDic = new HashMap<String, String>();
        categories_nameDic.put("nba", "Basketbol/NBA");
        categories_nameDic.put("vtb", "Basketbol/vtb-league");
