...
public class ParsingSportBoxBoks extends Data {
    Map<String, String> categories_nameDic;
    public ParsingSportBoxBoks() {
        source_id = 2L;

        categories_name = new String[] {
                "lyubitelskij","professionalnyj"};
        categories_nameDic = new HashMap<String, String>();
        categories_nameDic.put("lyubitelskij", "Boks/Lyubitelskij");
        categories_nameDic.put("professionalnyj", "Boks/Professionalnyj");
