...
public class ParsingSportBoxVolleyball extends Data  {
    Map<String, String> categories_nameDic;
    public ParsingSportBoxVolleyball() {
        source_id = 2L;

        categories_name = new String[] {
                "russian","eurocups"};
        categories_nameDic = new HashMap<String, String>();
        categories_nameDic.put("russian", "Volejbol/Chempionat_Rossii");
        categories_nameDic.put("eurocups", "Volejbol/Eurocups");
